...
#pragma endregion
	...
	class BehaviorConditionalInverter : public BehaviorConditional
	{
	public:
		explicit BehaviorConditionalInverter(std::function<bool(Blackboard*)> fp) : BehaviorConditional(fp) {}
		virtual BehaviorState Execute(Blackboard* pBlackBoard) override;
	};
	...
	class BehaviorActionInverter : public BehaviorAction
	{
	public:
		explicit BehaviorActionInverter(std::function<BehaviorState(Blackboard*)> fp) : BehaviorAction(fp) {}
		virtual BehaviorState Execute(Blackboard* pBlackBoard) override;
	};
