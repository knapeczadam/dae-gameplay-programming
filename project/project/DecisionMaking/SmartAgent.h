...
public:
	...
	Face*      GetFaceBehavior()      const;
	RadarSeek* GetRadarSeekBehavior() const;
	Flee*      GetFleeBehavior()      const;
	Evade*     GetEvadeBehavior()     const;
	Arrive*    GetArriveBehavior()    const;
...
protected:
	...
	RadarSeek* m_pRadarSeek = nullptr;
